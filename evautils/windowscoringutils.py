...
def displayResults(method_list, top_motif_ids, methods_to_plot_list, motif_id_to_motif_length, motif_id_to_hit_locations, motif_len_to_negatives, method_to_seq_id_to_scores, motif_id_to_pos_locs):
	motif_info={}
...
def windowScoring(method_to_saved_scores, seq_len, seq_ids_of_interest, motif_matches, relevant_labels_list, ig_seq_ids_of_interest, method_to_seq_id_to_scores, seq_id_to_covered_positions, motif_id_to_hit_locations, motif_id_to_motif_length, motif_len_to_negatives):
